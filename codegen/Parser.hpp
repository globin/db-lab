...
struct Parser {
    ...
    enum class State : unsigned {
        ...
        Index, IndexName, IndexTableName, IndexColumns, IndexColumnBegin, IndexColumnName, IndexEnd,
        Key, KeyListBegin, KeyName, KeyListEnd, AttributeName, AttributeTypeInt, AttributeTypeTimestamp,
